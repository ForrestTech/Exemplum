namespace Exemplum.Infrastructure.Identity
{
    ...
    public class FakeUser : ICurrentUser
    {
        ...
        public string? UserId => _httpContextAccessor.HttpContext?.User?.FindFirstValue(ClaimTypes.NameIdentifier) ?? "richard.a.forrest@gmail.com";
        public ClaimsPrincipal? Principal => _httpContextAccessor.HttpContext?.User?.FindFirstValue(ClaimTypes.NameIdentifier) != null ?
