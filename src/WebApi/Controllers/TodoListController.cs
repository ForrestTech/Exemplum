...
namespace WebApi.Controllers
{
    ...
    public class TodoListController : ApiControllerBase
    {
        ...
        public async Task<ActionResult<PaginatedList<TodoItemDto>>> Completed(int listId,
        ...
        public async Task<ActionResult> UpdateTodo(int listId, int todoId, [FromBody] UpdateTodoCommand command)
        {
            command.ListId = listId;
        ...
        public async Task<ActionResult> DeleteTodo(int listId, int todoId)
        {
        ...
        public async Task<ActionResult> MarkTodoCompleted(int listId, int todoId)
        {
